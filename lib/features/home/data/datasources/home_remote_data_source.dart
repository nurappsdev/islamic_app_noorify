...
/// Talks to `GET /home/dashboard`. Throws [ServerException] /
...
class HomeRemoteDataSourceImpl implements HomeRemoteDataSource {
  HomeRemoteDataSourceImpl({Dio? dio, AuthLocalDataSource? local})
  ...
  Future<HomeDashboardModel> getDashboard() async {
    ...
    try {
      response = await _dio.get<dynamic>(
        ApiConstants.homeDashboardEndPoint,
        options: Options(
    ...
    if (data is! Map<String, dynamic>) {
      throw ParsingException('Dashboard response is missing "data".');
    }
