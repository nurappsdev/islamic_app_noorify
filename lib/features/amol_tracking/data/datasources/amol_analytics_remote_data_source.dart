...
import 'package:islami_app_noorify/features/amol_tracking/data/models/amol_analytics_graph_model.dart';
import 'package:islami_app_noorify/features/auth/data/datasources/auth_local_data_source.dart';

/// Talks to the Amol analytics/graph REST endpoint. Throws
...
class AmolAnalyticsRemoteDataSourceImpl
    implements AmolAnalyticsRemoteDataSource {
  AmolAnalyticsRemoteDataSourceImpl({Dio? dio, AuthLocalDataSource? local})
  ...
  Future<AmolAnalyticsGraphModel> getGraph({
    ...
    if (data is! Map<String, dynamic>) {
      throw ParsingException('Amol analytics response is missing "data".');
    }
    return AmolAnalyticsGraphModel.fromJson(data);
  }
